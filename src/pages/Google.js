      ...
      <div className="main flex flex-col">
        ...
        <div className="links flex space-x-3 justify-end items-center p-4 font-sans z-100">
          ...
          <div className='flex items-center space-x-4'>
            <i class="bi bi-bricks cursor-pointer p-1 text-[#e2e2e2]"></i>
        ...
        <div className='mt-20 flex container justify-center items-center flex-col'>
          <Image className='mx-auto my-auto mt-3' src={`https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png`} alt="Logo" height={100} width={280}></Image>
          ...
          <div className='flex flex-col items-center mt-6 rounded-full border-[#707070] border'>
            ...
            <div className='flex items-center space-x-2 pl-5 pr-5 py-2'>
              <i class="bi bi-search text-[#707070]"></i>
              <input className='bg-[#202124] outline-none rounded-md p-1 w-[65vh] text-sm' type="text" placeholder='Search Google or type a URL' />
              <div className='space-x-2'>
                <i class="bi bi-camera cursor-pointer" title='Search by Image'></i>
                <i class="bi bi-mic cursor-pointer" title='Search by Voice '></i>
              </div>
            </div>
          </div>
          {/* Buttons */}
          <div className='flex space-x-3 mt-7'>
            <button className='bg-[#303134] text-white hover:outline hover:outline-1 hover:outline-[#717171] justify-center items-center rounded-md p-2 px-5 text-sm'>Google Search</button>
